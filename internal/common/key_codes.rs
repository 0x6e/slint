...
macro_rules! for_each_special_keys {
    ($macro:ident) => {
        $macro![
'\u{0008}'  # Backspace   # Qt_Key_Key_Backspace    # Backspace     # KEY_BackSpace  ;
'\u{0009}'  # Tab         # Qt_Key_Key_Tab          # Tab           # KEY_Tab        ;
'\u{000a}'  # Return      # Qt_Key_Key_Enter|Qt_Key_Key_Return # NumpadEnter|Enter # KEY_Return;
...
'\u{0010}'  # Shift       # Qt_Key_Key_Shift        # ShiftLeft    # KEY_Shift_L    ;
'\u{0011}'  # Control     # Qt_Key_Key_Control      # ControlLeft  # KEY_Control_L  ;
'\u{0012}'  # Alt         # Qt_Key_Key_Alt          # AltLeft      # KEY_Alt_L      ;
'\u{0013}'  # AltGr       # Qt_Key_Key_AltGr        # AltRight     # KEY_Mode_switch;
'\u{0014}'  # CapsLock    # Qt_Key_Key_CapsLock     #              # KEY_Caps_Lock  ;

'\u{0015}'  # ShiftR      #                         # ShiftRight   # KEY_Shift_R    ;
'\u{0016}'  # ControlR    #                         # ControlRight # KEY_Control_R  ;
...
'\u{0017}'  # Meta        # Qt_Key_Key_Meta         # SuperLeft    # KEY_Meta_L     ;
'\u{0018}'  # MetaR       #                         # SuperRight   # KEY_Meta_R     ;

'\u{F700}'	# UpArrow     # Qt_Key_Key_Up           # ArrowUp      # KEY_Up         ;
'\u{F701}'	# DownArrow   # Qt_Key_Key_Down         # ArrowDown    # KEY_Down       ;
'\u{F702}'	# LeftArrow   # Qt_Key_Key_Left         # ArrowLeft    # KEY_Left       ;
'\u{F703}'	# RightArrow  # Qt_Key_Key_Right        # ArrowRight   # KEY_Right      ;
...
//'\u{F71C}'# F25         # Qt_Key_Key_F25          # F25          # KEY_F25        ;
//'\u{F71D}'# F26         # Qt_Key_Key_F26          # F26          # KEY_F26        ;
//'\u{F71E}'# F27         # Qt_Key_Key_F27          # F27          # KEY_F27        ;
//'\u{F71F}'# F28         # Qt_Key_Key_F28          # F28          # KEY_F28        ;
//'\u{F720}'# F29         # Qt_Key_Key_F29          # F29          # KEY_F29        ;
//'\u{F721}'# F30         # Qt_Key_Key_F30          # F30          # KEY_F30        ;
//'\u{F722}'# F31         # Qt_Key_Key_F31          # F31          # KEY_F31        ;
//'\u{F723}'# F32         # Qt_Key_Key_F32          # F32          # KEY_F32        ;
//'\u{F724}'# F33         # Qt_Key_Key_F33          # F33          # KEY_F33        ;
//'\u{F725}'# F34         # Qt_Key_Key_F34          # F34          # KEY_F34        ;
//'\u{F726}'# F35         # Qt_Key_Key_F35          # F35          # KEY_F35        ;
...
'\u{F72F}'	# ScrollLock  # Qt_Key_Key_ScrollLock   # ScrollLock   # KEY_Scroll_Lock;
'\u{F730}'	# Pause       # Qt_Key_Key_Pause        # Pause        # KEY_Pause      ;
'\u{F731}'	# SysReq      # Qt_Key_Key_SysReq       # PrintScreen  # KEY_Sys_Req    ;
//'\u{F732}'	# Break       #                         #              ;
//'\u{F733}'	# Reset       #                         #              ;
'\u{F734}'	# Stop        # Qt_Key_Key_Stop         #              # KEY_XF86Stop   ;
'\u{F735}'	# Menu        # Qt_Key_Key_Menu         # ContextMenu  # KEY_Menu       ;
//'\u{F736}'	# User        #                         #              ;
//'\u{F737}'	# System      #                         #              ;
